...
PRED_JSON = "/workspace/outputs/evaluate_output/runs/yolo11m_eval/predictions.json"
...
def main():
    ...
    df.to_csv("/workspace/outputs/evaluate_output/runs/yolo11m_eval/predictions_analysis.csv", index=False)
